...
public:
 	...
 	std::shared_ptr<std::vector<int>> activationList, std::shared_ptr<std::vector<uint32_t>> layersSizes);
    ...
    std::shared_ptr<std::vector<uint32_t>> _layersSizes; //TODO try to use shared pointers
    int modelType;
