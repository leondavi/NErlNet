...
enum ModelTypeEnum{MODEL_TYPE_NN=0,MODEL_TYPE_APPROXIMATION=1,MODEL_TYPE_CLASSIFICATION=2,MODEL_TYPE_FORECASTING=3,MODEL_TYPE_IMAGE_CLASSIFICATION=4,MODEL_TYPE_TEXT_CLASSIFICATION=6,MODEL_TYPE_TEXT_GENERATION=7,MODEL_TYPE_AUTO_ASSOCIATION=8,MODEL_TYPE_AUTOENCODER=9,MODEL_TYPE_AE_CLASSIFIER=10};
