...
enum WorkerDistributedSystemTypeEnum{WORKER_DISTRIBUTED_SYSTEM_TYPE_NONE=0,WORKER_DISTRIBUTED_SYSTEM_TYPE_TILES=1,WORKER_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTAVG=2,WORKER_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERAVG=3,WORKER_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTWEIGHTEDAVGCLASSIFICATION=4,WORKER_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERWEIGHTEDAVGCLASSIFICATION=5,WORKER_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTAE=6,WORKER_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERAE=7};
