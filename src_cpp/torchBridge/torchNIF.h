...
static ErlNifFunc nif_funcs[] =
{
    ...
    {"train_nif", 3 , train_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"train_microbatch_nif", 4, train_microbatch_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"optimizer_barrier_nif", 1, optimizer_barrier_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"pipeline_stage0_forward_nif", 5, pipeline_stage0_forward_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"pipeline_stage_forward_nif", 7, pipeline_stage_forward_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"pipeline_stage_last_forward_backward_nif", 7, pipeline_stage_last_forward_backward_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"pipeline_stage_backward_nif", 5, pipeline_stage_backward_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"pipeline_predict_stage0_forward_nif", 3, pipeline_predict_stage0_forward_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"pipeline_predict_stage_forward_nif", 3, pipeline_predict_stage_forward_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"predict_nif", 3 , predict_nif, ERL_NIF_DIRTY_JOB_CPU_BOUND},
