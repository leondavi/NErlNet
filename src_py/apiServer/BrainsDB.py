class BatchTrainDB:
    def __init__(self, worker_name, source_name, batch_id, batch_size, source_starting_offset, duration = None):
        self.worker_name = worker_name
        self.source_name = source_name
        self.source_starting_offset = 0 # line number of frame index from where batch idx 0 starts at.
...
class BatchPredictDB:
    def __init__(self, worker_name, source_name, batch_id, batch_size, source_starting_offset = 0, label_dim = 1, duration = None):
        self.worker_name = worker_name
        self.source_name = source_name
        self.source_starting_offset = 0 # line number of frame index from where batch idx 0 starts at.
        self.batch_id = batch_id
