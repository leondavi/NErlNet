...
KEY_DC_JSON_LOAD_FROM_BROWSE_BUTTON = '-KEY-DC-JSON-LOAD-FROM-BROWSE-BUTTON-' # not in use
KEY_DC_JSON_LOAD_FROM_INPUT = '-KEY-DC-JSON-LOAD-FROM-BROWSE-BUTTON-'
KEY_DC_JSON_LOAD_BUTTON = '-KEY-DC-JSON-LOAD-BUTTON-'
