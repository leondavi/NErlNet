...
KEY_SETTINGS_MAINSERVER_PORT_INPUT = '-KEY-SETTINGS-MAINSERVER-IP-INPUT-' 
KEY_SETTINGS_APISERVER_IP_INPUT = '-KEY-SETTINGS-APISERVER-IP-INPUT-'
KEY_SETTINGS_APISERVER_PORT_INPUT = '-KEY-SETTINGS-APISERVER-IP-INPUT-' 
KEY_SETTINGS_NERLGUI_IP_INPUT = '-KEY-SETTINGS-NERLGUI-IP-INPUT-'
KEY_SETTINGS_NERLGUI_PORT_INPUT = '-KEY-SETTINGS-NERLGUI-IP-INPUT-' 
