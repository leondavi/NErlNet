...
KEY_PROBABILISTIC_LAYER = "porbabilistic_activation_layer"
KEY_PROBABILISTIC_LAYER_DOC = "_doc_porbabilistic_activation"
KEY_LAYERS_FUNCTIONS = "layers_functions"
KEY_LAYERS_FUNCTIONS_DOC = "_doc_layers_functions"
...
VAL_PROBABILISTIC_LAYER_DOC = f"{doc_print_dict(ProbabilisticActivationFunctionMap)}"
