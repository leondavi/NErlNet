...
export TEST_BASELINE_DIR="$TESTS_PATH/$TEST_INPUT_JSONS_FILES_DIR/baseline"
...
export TEST_BASELINE_LOSS_MIN="$TEST_BASELINE_DIR/$TEST_BASELINE_LOSS_MIN_FILENAME.json"
