...
-define(CNN_1D_TESTING_NN,{     _ModelIdCNN_1D  = erlang:unique_integer([positive]),
                                _ModelTypeCNN_1D = "0",
                                _ModelArgsCNN_1D = "",
                                _LayersSizesCNN_1D = "70x1x1k5x1x1x128p0s1t1 cnn ,66x1x128k2x1p0s1 pool,65x1x128k5x1x128x128p0s1t1 cnn,61x1x128k2x1p0s1 pool,
                                60x1x128k5x1x128x64p0s1t0 cnn,1 flat,64 p, 32 p, 16 p,9 softmax",
                                _LayersTypesCNN_1D = "2,4,2,4,2,10,3,3,3,5",
                                _LayersFunctionalityCodesCNN = "", % change scaler functionality to 6 to check exception handling
