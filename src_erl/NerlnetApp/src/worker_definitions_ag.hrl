...
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTWEGITHEDAVGCLASSIFICATION_KEY_ATOM,fedClientWegithedAvgClassification).
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERWEGITHEDAVGCLASSIFICATION_KEY_ATOM,fedServerWegithedAvgClassification).
...
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTWEGITHEDAVGCLASSIFICATION_IDX_STR,"3").
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERWEGITHEDAVGCLASSIFICATION_IDX_STR,"4").
...
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTWEGITHEDAVGCLASSIFICATION_IDX,3).
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERWEGITHEDAVGCLASSIFICATION_IDX,4).
