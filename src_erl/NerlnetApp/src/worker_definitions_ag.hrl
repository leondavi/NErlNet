...
-define(DC_DISTRIBUTED_SYSTEM_TYPE_TILES_IDX_STR,"1").
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTAVG_IDX_STR,"2").
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERAVG_IDX_STR,"3").
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTWEIGHTEDAVGCLASSIFICATION_IDX_STR,"4").
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERWEIGHTEDAVGCLASSIFICATION_IDX_STR,"5").
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTAE_IDX_STR,"6").
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERAE_IDX_STR,"7").

-define(DC_DISTRIBUTED_SYSTEM_TYPE_NONE_IDX,0).
-define(DC_DISTRIBUTED_SYSTEM_TYPE_TILES_IDX,1).
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTAVG_IDX,2).
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERAVG_IDX,3).
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTWEIGHTEDAVGCLASSIFICATION_IDX,4).
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERWEIGHTEDAVGCLASSIFICATION_IDX,5).
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDCLIENTAE_IDX,6).
-define(DC_DISTRIBUTED_SYSTEM_TYPE_FEDSERVERAE_IDX,7).
